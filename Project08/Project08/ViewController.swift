...
//  Project08
//
//  Created by Angel Vázquez on 3/9/19.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        //  Buttons inside the buttons view
        let width = 150
        let height = 80
        ...
        for row in 0 ..< 4 {
            for col in 0 ..< 5 {
                ...
                //letterButton.backgroundColor = .random
    ...
    @objc func letterTapped(_ sender: UIButton) {
        ...
        UIView.animate(withDuration: 0.5, delay: 0, options: [], animations: { sender.alpha = 0 }, completion: { _ in sender.isHidden = true })
    }
